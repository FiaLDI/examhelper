...
export const projectsData: Record<Language, ProjectItem[]> = {
  en: [
    // ============================
    // CORE
    // ============================
    {
      ...
      description:
        "Designed and implemented a modular real-time communication platform with private channels, role-based access control, moderation workflows, and distributed services. Focused on scalability, clean architecture principles, and long-term maintainability.",
      tech: [
        "React",
        "Next.js",
        "Express",
